<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
   ...
   <ul class="menu-inner py-1">
      ...
      <!-- Dashboards -->
      <li class="menu-item {{request()->route()->getName() == 'admin.dashboard' ? 'open active' : ''}}">
      ...
      <!-- Orders -->
      <li class="menu-item @php echo in_array(request()->route()->getName(), ['admin.orders','admin.order.show']) ? 'open active' : ''@endphp">
      ...
      <!-- Users -->
      <li class="menu-item @php echo in_array(request()->route()->getName(), ['admin.users']) ? 'open active' : ''@endphp">
