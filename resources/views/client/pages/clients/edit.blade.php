                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="company" name="company" value="{{ old('company', $client->company) }}" placeholder="Enter Company"/>
                        </div>

                        <!-- Tax ID -->
                        <div class="mb-3">
                            <label class="form-label" for="tax_id">Tax ID</label>
                            <input type="text" class="form-control" id="tax_id" name="tax_id" value="{{ old('tax_id', $client->tax_id) }}" placeholder="Enter Tax ID"/>
                        </div>
