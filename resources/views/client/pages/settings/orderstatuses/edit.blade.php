...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 breadcrumb-wrapper mb-4">
        <span class="text-muted fw-light">Settings /</span> Edit Order Status
    </h4>
    ...
    <div class="row">
        <div class="col-xl">
            ...
            <form id="order_status_form" method="POST" action="{{ route('setting.orderstatuses.update', $status->id) }}">
                @csrf
                @method('POST')
