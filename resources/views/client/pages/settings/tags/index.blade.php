            ...
            <div class="col-md-12">
                <div class="dt-action-buttons text-xl-end text-lg-start text-md-end text-start d-flex align-items-center justify-content-end flex-md-row flex-column mb-3 mb-md-0">
                    <div id="DataTables_Table_0_filter" class="dataTables_filter">
                        <form action="{{ route('client.tags.list') }}" method="GET" class="dataTables_filter" id="DataTables_Table_0_filter">
                            <label>
                    ...
                    <div class="dt-buttons">
                        &nbsp;
                        <button onclick="window.location.href='{{ route('client.tags.create') }}'" class="dt-button add-new btn btn-primary ms-n1" tabindex="0" aria-controls="DataTables_Table_0" type="button">
                ...
                <tbody class="table-border-bottom-0">
                    @if($tags->count() > 0)
                        ...
                        <tr>
                            ...
                            <td>
                                <!-- Edit Button -->
                                <a href="{{ route('client.tags.edit', $tag->id) }}" class="btn btn-sm btn-primary">Edit</a>

                                <!-- Delete Button -->
                                <form action="{{ route('client.tags.delete', $tag->id) }}" method="POST" style="display:inline-block;">
                                    @csrf
                                    @method('DELETE')
