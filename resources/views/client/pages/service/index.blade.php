            ...
            <div class="col-md-12">
                <div class="dt-action-buttons text-xl-end text-lg-start text-md-end text-start d-flex align-items-center justify-content-end flex-md-row flex-column mb-3 mb-md-0">
                    <div id="DataTables_Table_0_filter" class="dataTables_filter">
                        <form action="{{ route('service.list') }}" method="GET" class="dataTables_filter" id="DataTables_Table_0_filter">
                            <label>
                    ...
                    @if(checkPermission('add_edit_delete_services'))
                        <div class="dt-buttons">
                            ...
                            <button onclick="window.location.href='{{ route('service.add') }}'" class="dt-button add-new btn btn-primary ms-n1" tabindex="0" aria-controls="DataTables_Table_0" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasAddUser">
