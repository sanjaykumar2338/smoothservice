...
<html
  ...
  <head>
    ...
    <title>
        {{ isset($companySetting) && $companySetting->company_name ? $companySetting->company_name : env('APP_NAME') }}
    </title>
          ...
          <div class="w-px-400 mx-auto">
            ...
            <a href="{{ url('/') }}" class="app-brand-link gap-2 mb-2">
                <span class="app-brand-logo demo">
                    @if(isset($companySetting) && $companySetting->application_icon && file_exists(public_path('storage/' . $companySetting->application_icon)))
                        <img src="{{ asset('storage/' . $companySetting->application_icon) }}" alt="Logo" style="height: 40px;">
                    @else
                        <svg
                            width="26px"
                            height="26px"
